...
//    var salt = "4R38IvwiV57FwVpsgOvTXBdLE4tHUXFW"
    //live
//    var merchantKey = "XpvgUb"
//    var salt = "6PUiBWV9ifmIlGhabPPzkcOoApqWRkqQ"
    
    let keySalt = [
        ["XpvgUb", "6PUiBWV9ifmIlGhabPPzkcOoApqWRkqQ", Environment.production] as [Any],
    ...
    var productInfo: String = "EVCharging"
    ...
    var firstName: String = "EVCharging"
    var email: String = "EVCharging@gmail.com"
    var phoneNumber: String = "9876543210"
    var userCredential: String = "EVCharging:EVCharging@gmail.com"
    var primaryColor: String = "#25272C"
    var secondaryColor: String = "#ffffff"
    var merchantName: String = "EVCharging"
...
extension MerchantViewController: PayUCheckoutProDelegate {
    ...
    func onPaymentSuccess(response: Any?) {
        ...
        navigationController?.popToViewController(self, animated: true)
        showAlertPayu(title: "Success", message: "\(response ?? "")")
